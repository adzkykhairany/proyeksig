...
<script>
   var Grayscale = L.tileLayer('https://api.mapbox.com/styles/v1/{id}/tiles/{z}/{x}/{y}?access_token=pk.eyJ1IjoibWFwYm94IiwiYSI6ImNpejY4NXVycTA2emYycXBndHRqcmZ3N3gifQ.rJcFIG214AriISLbB6B5aw', {
    ...
    //polygon
    L.polygon([
        [-7.428093279898773, 109.33600388870163],
        [-7.428258383724956, 109.3386146513518],
        [-7.4297694355671275, 109.33860251332693],
        [-7.429779771460014, 109.33950413798989],
        [-7.431152336343145, 109.33946075567705],
        [-7.430456702133722, 109.33495229766582],
    ], {
        color: 'yellow',
        fillOpacity: 0.6,
    }
    )
    .bindPopup("<b>Wilayah A</b><br>" + "Nama : Fakultas Teknik")
    .addTo(map);
</script>